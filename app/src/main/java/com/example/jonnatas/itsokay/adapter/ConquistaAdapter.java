...
public class ConquistaAdapter extends ArrayAdapter<Conquistas> {

    private ArrayList<Conquistas> conquistas;
    private Context context;

    public ConquistaAdapter(@NonNull Context context, @NonNull ArrayList<Conquistas> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (conquistas == null) {
            ...
            Conquistas conquista = getItem(position);
